...
function Industries() {
  ...
  const industries = [
    ...
    { name: "Government", color: "bg-[#FFA37C]" },
    ...
    <div className="bg-[#E8F4D9] py-20 px-6 md:px-25">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          <button onClick={handleLetsTalk} className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-full font-medium transition-colors duration-200">
            Let's talk
          </button>
          <Link to="/services" className="border-2 border-blue-500 text-blue-500 hover:bg-blue-50 px-8 py-3 rounded-full font-medium transition-colors duration-200">
            Learn more
          </Link>
        </div>
