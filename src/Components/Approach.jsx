        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="inline-block">
              <span className="bg-[#8DC63F] text-white px-4 py-2 rounded-[4px] text-sm font-medium">
                OUR APPROACH
              </span>
            </div>
          ...
          <div className="space-y-6">
            {steps.map((step) => (
              <div key={step.number} className="bg-[#D3EEF9] rounded-2xl p-6 hover:shadow-lg transition-shadow">
